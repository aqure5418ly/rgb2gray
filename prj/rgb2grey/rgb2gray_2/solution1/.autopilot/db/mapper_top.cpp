...
static AESL_RUNTIME_BC __xlx__V_size_Reader("../tv/stream_size/stream_size_out_.dat");
using hls::sim::Byte;
extern "C" void top(volatile void *, volatile void *, volatile void *, , volatile void *, , , volatile void *, volatile void *, volatile void *, , volatile void *, , , int, int);
...
auto* sdst_V_last_V = createStream((hls::stream<char>*)__xlx_apatb_param_dst_V_last_V);
  // DUT call
  top(ssrc_V_data_V->data<int>(), ssrc_V_keep_V->data<char>(), ssrc_V_strb_V->data<char>(), ssrc_V_last_V->data<char>(), sdst_V_data_V->data<char>(), sdst_V_keep_V->data<char>(), sdst_V_strb_V->data<char>(), sdst_V_last_V->data<char>(), __xlx_apatb_param_rows, __xlx_apatb_param_cols);
