...
__attribute__((sdx_kernel("rgb2gray_top", 0))) void rgb2gray_top(hls::stream<rgb>& src, hls::stream<gray>& dst, int rows, int cols);
# 2 "../src/rgb2gray.h" 2
...
__attribute__((sdx_kernel("rgb2gray_top", 0))) void rgb2gray_top(hls::stream<rgb>& src, hls::stream<gray>& dst, int rows, int cols) {
#line 21 "/root/Xilinx/rgb2grey/prj/rgb2grey/solution1/csynth.tcl"
...
#pragma HLS INTERFACE s_axilite port=return bundle=CTRL
 ...
 rgb_pixel rgb_tmp;
  ...
  VITIS_LOOP_17_1: for (int i = 0; i < rows; i++) {

    VITIS_LOOP_19_2: for (int j = 0; j < cols; j ++) {
#pragma HLS PIPELINE
 switch(count) {
            case 0:
