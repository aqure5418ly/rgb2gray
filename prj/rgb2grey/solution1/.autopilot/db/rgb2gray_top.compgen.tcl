...
set name rgb2gray_top_mul_32ns_32ns_64_1_1
...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 21 \
			corename rgb2gray_top_CTRL_axilite \
			name rgb2gray_top_CTRL_s_axi \
			ports {$port_CTRL} \
			op interface \
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler rgb2gray_top_CTRL_s_axi BINDTYPE interface TYPE interface_s_axilite
}
...
# RegSlice definition:
set ID 30
set RegSliceName rgb2gray_top_regslice_both
set RegSliceInstName rgb2gray_top_regslice_both_U
set CoreName ap_simcore_rgb2gray_top_regslice_both
if {${::AESL::PGuard_rtl_comp_handler}} {
