...
if {[file isfile rgb2gray_top.autotvin.dat]} {
	file delete -force rgb2gray_top.autotvin.dat
}

if {[file isfile rgb2gray_top.autotvout.dat]} {
	file delete -force rgb2gray_top.autotvout.dat
}
