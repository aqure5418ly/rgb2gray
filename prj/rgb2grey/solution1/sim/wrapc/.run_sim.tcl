...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "rgb2gray_top.autotvin.dat"
	set constFileTvOut       "rgb2gray_top.autotvout.dat"
	set constFileHdlTvIn     "rgb2gray_top.autohdltvin.dat"
	set constFileHdlTvOut    "rgb2gray_top.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
